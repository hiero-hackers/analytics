...
COMMANDS: list[Command] = [
    ...
    Command(
        ...
        func=lambda args: __import__("hiero_analytics.run_onboarding_signal_for_repo", fromlist=["run"]).run(args.org, args.repo)
    ),
    ...
    Command(
        ...
        func=lambda _: __import__("hiero_analytics.run_contributor_activity_org", fromlist=["main"]).main()
    ),
    ...
    Command(
        ...
        func=lambda _: __import__("hiero_analytics.run_contributor_profiles_repo", fromlist=["main"]).main()
    ),

    Command(
        name="difficulty",
        description="Run repo difficulty analysis",
        func=lambda _: __import__("hiero_analytics.run_difficulty_org_for_repo", fromlist=["main"]).main()
    ),
    ...
    Command(
        ...
        func=lambda _: __import__("hiero_analytics.run_contributor_churn_analysis", fromlist=["run"]).run()
    )
]
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    for command in COMMANDS:
        ...
        for arg in command.args:
            command_parser.add_argument(arg.name, metavar=arg.metavar, dest=arg.dest, help=arg.description, default=arg.default_value)
