...
def plot_pie(
    ...
    with figure_context() as (fig, ax):
        ...
        # The detailed breakdown lives in the legend, placed in the reserved
        # right-hand whitespace via the shared, style-consistent legend path.
        finalize_chart(
            fig=fig,
            ax=ax,
            title=title,
            ...
            legend_title=label_col.replace("_", " ").title(),
